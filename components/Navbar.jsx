        ...
        <div className="md:hidden bg-white border-b border-gray-100 shadow-lg absolute w-full">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link
              href="/login"
              onClick={() => setIsOpen(false)}
              className="flex items-center justify-center gap-2 px-3 py-3 mt-4 text-center rounded-xl text-base font-bold bg-purple-600 text-white hover:bg-purple-700 shadow-md"
            >
